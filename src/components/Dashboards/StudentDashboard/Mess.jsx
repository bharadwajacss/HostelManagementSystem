...
function Mess() {
  let requestMessOff = async (event) => {
    ...
    let response = await fetch("https://hostelmanagementbackend-2tc9.onrender.com/api/Messoff/request", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    if (student) {
      fetch("https://hostelmanagementbackend-2tc9.onrender.com/api/Messoff/count", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
