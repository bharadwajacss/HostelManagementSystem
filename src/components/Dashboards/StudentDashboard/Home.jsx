...
const List = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://hostelmanagementbackend-2tc9.onrender.com/api/invoice/student", {
      method: "POST",
      headers: {
...
function Home() {
  ...
  const getAttendance = async () => {
    let student = JSON.parse(localStorage.getItem("student"));
    const res = await fetch("https://hostelmanagementbackend-2tc9.onrender.com/api/attendance/get", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
